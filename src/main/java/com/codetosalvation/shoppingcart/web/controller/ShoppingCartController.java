...
public class ShoppingCartController {
	 ...
	 *
	 * @param bucket 1, 2 or 3
	 */
	@RequestMapping("loadcart/{bucket}")
	public @ResponseBody void loadShoppingCart(@PathVariable("bucket") String bucket) {
	 ...
	 *
	 * @param inputLineItem string data
	 */
	@RequestMapping(value = "addcart", method = RequestMethod.POST)
	public @ResponseBody void addCart(@RequestBody String inputLineItem) {
	...
	public @ResponseBody List<ShoppingCartLineItem> viewShoppingCart() {
	 ...
	 *
	 * @param bucket possible values are 1, 2 or 3
	 * @return List of strings
	 */
	@RequestMapping("viewbucketinput")
	public @ResponseBody List<String> viewBucketInput(@RequestParam("bucket") int bucket) {
